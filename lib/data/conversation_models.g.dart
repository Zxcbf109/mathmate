...
int _conversationEstimateSize(
  ...
  bytesCount += 3 + object.messages.length * 3;
  {
    ...
    for (var i = 0; i < object.messages.length; i++) {
      ...
      bytesCount +=
          ChatMessageEmbeddedSchema.estimateSize(value, offsets, allOffsets);
    }
  }
...
Conversation _conversationDeserialize(
  ...
  object.id = id;
  object.messages = reader.readObjectList<ChatMessageEmbedded>(
        offsets[1],
...
extension ConversationQueryProperty
  ...
  QueryBuilder<Conversation, List<ChatMessageEmbedded>, QQueryOperations>
      messagesProperty() {
    return QueryBuilder.apply(this, (query) {
...
extension ChatMessageEmbeddedQueryFilter on QueryBuilder<ChatMessageEmbedded,
    ChatMessageEmbedded, QFilterCondition> {
...
extension ChatMessageEmbeddedQueryObject on QueryBuilder<ChatMessageEmbedded,
    ChatMessageEmbedded, QFilterCondition> {}
